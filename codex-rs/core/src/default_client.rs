...
mod tests {
    ...
    async fn test_create_client_sets_default_headers() {
        ...
        assert_eq!(
            originator_header.to_str().expect("originator header value"),
            originator().value
        );
        ...
        assert_eq!(
            ua_header.to_str().expect("user-agent header value"),
            expected_ua
        );
        ...
        assert_eq!(
            residency_header.to_str().expect("residency header value"),
            "us"
        );
