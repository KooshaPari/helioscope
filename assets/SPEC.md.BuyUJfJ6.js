...
const u = JSON.parse(
    '{"title":"Technical Specification","description":"","frontmatter":{},"headers":[],"relativePath":"SPEC.md","filePath":"SPEC.md"}',
  ),
  l = { name: "SPEC.md" };
function r(o, t, s, p, d, f) {
  return (
    n(),
    i("div", null, [
      ...(t[0] ||
        (t[0] = [
          e(
            "h1",
            { id: "technical-specification", tabindex: "-1" },
            [
