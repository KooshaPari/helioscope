...
pub(crate) fn shortcut_overlay_lines(state: ShortcutsState) -> Vec<Line<'static>> {
...
impl ShortcutDescriptor {
    pub(crate) fn binding_for(&self, state: ShortcutsState) -> Option<&'static ShortcutBinding> {
...
pub(crate) const SHORTCUTS: &[ShortcutDescriptor] = &[
    ShortcutDescriptor {
